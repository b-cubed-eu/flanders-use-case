...
Angiosperm_data_cube <- process_cube(read.csv(paste0('./_preprocessing/data/raw/', Focus, '.csv')))
Angiosperm_data_cube_1km <- process_cube(read.csv(paste0('./_preprocessing/data/raw/', Focus_1km, '.csv')))
...
OSR_map_1km <- obs_richness_map(Angiosperm_data_cube_1km,
                            cell_size="grid")
