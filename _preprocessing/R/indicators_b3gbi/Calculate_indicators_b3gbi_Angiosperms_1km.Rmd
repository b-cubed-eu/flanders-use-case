...
Angiosperm_data_cube <- process_cube("C:/Users/jasmijn_hillaert/Documents/GitHub/Flanders_use_case/_preprocessing/data/raw/Angiosperm_data_Flanders_1km.csv")
...
OSR_ts <- OSR_ts %>% filter(year<= 2022)
...
OT_ts_plot <- plot(OT_ts, max_year=2022)
