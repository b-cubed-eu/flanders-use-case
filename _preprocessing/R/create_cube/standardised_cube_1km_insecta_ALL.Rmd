...
AND \"year\" >= 1975
  ...
  AND (occurrence.taxonkey IN ('216') OR occurrence.acceptedtaxonkey IN ('216') OR occurrence.kingdomkey IN ('216') OR occurrence.phylumkey IN ('216') OR occurrence.classkey IN ('216') OR occurrence.orderkey IN ('216') OR occurrence.familykey IN ('216') OR occurrence.genuskey IN ('216') OR occurrence.specieskey IN ('216'))
...
Insecta_ALL_1kmCS <- read.csv("~/GitHub/Flanders_use_case/_preprocessing/data/raw/Insecta_ALL_1kmCS.csv")

data_total_1km <- Insecta_ALL_1kmCS

be_animalia_native <-  read.csv('_preprocessing/data/interim/be_animalia_native.csv')
...
cube_native <- data_total_1km[data_total_1km$specieskey %in%
                              be_animalia_native$acceptedUsageKey,]
...
write.csv(Cube_Angio_Flanders,
          '_preprocessing/data/raw/Insecta_data_Flanders_1km_ALL.csv')
write.csv(Cube_Angio_Flanders_Natura2000,
          '_preprocessing/data/raw/Insecta_data_Flanders_Natura2000_ALL.csv')
write.csv(Cube_Angio_Flanders_nonNatura2000,
          '_preprocessing/data/raw/Insecta_data_Flanders_nonNatura2000_ALL.csv')
```
