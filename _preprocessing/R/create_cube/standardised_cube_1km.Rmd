...
WHERE
  ...
  AND(temporalUncertaintyInSeconds <= 315360000 or temporalUncertaintyInSecond IS NULL)
...
```{r}
FLANDERS_EEA_1km <- st_read('_preprocessing/data/spatial/EEA_1km_Flanders_union.geojson')
FLANDERS_EEA_1km_Natura2000 <- st_read('_preprocessing/data/spatial/EEA_1km_Natura2000.geojson')
FLANDERS_EEA_1km_nonNatura2000 <- st_read('_preprocessing/data/spatial/EEA_1km_nonNatura2000.geojson')
```
