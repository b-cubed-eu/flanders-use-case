...
write.csv(Cube_Angio_Flanders,
          '_preprocessing/data/raw/Insecta_data_Flanders_1km.csv')
write.csv(Cube_Angio_Flanders_Natura2000,
          '_preprocessing/data/raw/Insecta_data_Flanders_Natura2000.csv')
write.csv(Cube_Angio_Flanders_nonNatura2000,
          '_preprocessing/data/raw/Insecta_data_Flanders_nonNatura2000.csv')
```
