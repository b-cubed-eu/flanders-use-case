...
file <- occ_download_get("0026651-260519110011954")
...
GRIIS_Flanders <- read.csv('./_preprocessing/data/raw/GRIIS_Flanders.csv')


#remove aliens
cube_native <- data_total_1km%>%
  filter(!specieskey%in%GRIIS_Flanders$speciesid)
