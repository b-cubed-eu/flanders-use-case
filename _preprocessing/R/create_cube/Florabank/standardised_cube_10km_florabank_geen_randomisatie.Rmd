...
PARTITION BY orderkey, GBIF_EEARGCODE(10000, decimallatitude, decimallongitude, 0), \"year\")) ordercount,
IF(ISNULL(familykey), NULL, SUM(COUNT(*)) OVER (
PARTITION BY familykey, GBIF_EEARGCODE(10000, decimallatitude, decimallongitude, 0), \"year\")) familycount,
IF(ISNULL(genuskey), NULL, SUM(COUNT(*)) OVER (
PARTITION BY genuskey, GBIF_EEARGCODE(10000, decimallatitude, decimallongitude, 0), \"year\")) genuscount,
...
write.csv(Cube_Angio_Flanders,
          '_preprocessing/data/raw/Florabank_data_Flanders_10km_norandomisation.csv')
