...
```{r}
Angiosperm_data_cube <- process_cube(read.csv('./preprocessing/data/raw/Angiosperm_data.csv'))
...
```{r}
Flanders <- read_sf('./preprocessing/data/spatial/flanders_wgs84.geojson')
```
...
OSR_map <- obs_richness_map(Angiosperm_data_cube,
                            ...
                            level = "country", 
                            region = "Belgium",
                            shapefile_path = './preprocessing/data/spatial/Flanders.shp')
