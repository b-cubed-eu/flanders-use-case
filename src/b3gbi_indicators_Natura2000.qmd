...
title:  >
  ...
  </a>General indicators for Natura2000 versus nonNatura2000
format:
  html:
    code-fold: true
...
```{r, echo = FALSE}
OSR_map <- readRDS("./Flanders_Natura2000/OSR_map.rds")
plot_map(OSR_map, title = 'Natura2000')

OSR_map <- readRDS("./Flanders_nonNatura2000/OSR_map.rds")
plot_map(OSR_map, title= 'nonNatura2000')


```

```{r, echo = FALSE}
OSR_ts <- readRDS('./Flanders_Natura2000/OSR_ts.rds')
plot_ts(OSR_ts, title = "Natura2000")

OSR_ts <- readRDS('./Flanders_nonNatura2000/OSR_ts.rds')
plot_ts(OSR_ts, title = "nonNatura2000")
```
:::
...
```{r, echo = FALSE}
TO_map <- readRDS('./Flanders_Natura2000/TO_map.rds')
plot(TO_map)
```

```{r, echo = FALSE}
TO_ts <- readRDS('./Flanders_Natura2000/TO_ts.rds')
plot(TO_ts)
```
:::
...
```{r, echo = FALSE}
PEM_map <- readRDS('./Flanders_Natura2000/PEM_map.rds')
plot(PEM_map)
```

```{r, echo = FALSE}
PEM_ts <- readRDS('./Flanders_Natura2000/PEM_ts.rds')
plot(PEM_ts)
```
...
```{r, echo = FALSE}
WEM_map <- readRDS('./Flanders_Natura2000/WEM_map.rds')
plot(WEM_map)
```

```{r, echo = FALSE}
WEM_ts <- readRDS('./Flanders_Natura2000/WEM_ts.rds')
plot(WEM_ts)
```
:::
...
```{r, echo = FALSE}
AbRM_map <- readRDS('./Flanders_Natura2000/AbRM_map.rds')
plot(AbRM_map)
```

```{r, echo = FALSE}
AbRM_ts <- readRDS('./Flanders_Natura2000/AbRM_ts.rds')
plot(AbRM_ts)
```
...
```{r, echo = FALSE}
ArRM_map <- readRDS('./Flanders_Natura2000/ArRM_map.rds')
plot(ArRM_map)
```

```{r, echo = FALSE}
ArRM_ts <- readRDS('./Flanders_Natura2000/ArRM_ts.rds')
plot(ArRM_ts)
```
:::
...
```{r, echo = FALSE}
SR_map <- readRDS('./Flanders_Natura2000/SR_map.rds')
plot(SR_map)
```

```{r, echo = FALSE}
SR_ts <- readRDS('./Flanders_Natura2000/SR_ts.rds')
plot(SR_ts)
```
...
```{r, echo = FALSE}
HSh_map <- readRDS('./Flanders_Natura2000/HSh_map.rds')
plot(HSh_map)
```

```{r, echo = FALSE}
HSh_ts <- readRDS('./Flanders_Natura2000/HSh_ts.rds')
plot(HSh_ts)
```
...
```{r, echo = FALSE}
HSi_map <- readRDS('./Flanders_Natura2000/HSi_map.rds')
plot(HSi_map)
```

```{r, echo = FALSE}
HSi_ts <- readRDS('./Flanders_Natura2000/HSi_ts.rds')
plot(HSi_ts)
```
:::
...
```{r, echo = FALSE}
CR_ts <- readRDS('./Flanders_Natura2000/CR_ts.rds')
plot(OSR_ts)
```
:::
...
```{r, echo = FALSE}
NN_map <- readRDS('./Flanders_Natura2000/NN_map.rds')
plot(NN_map)
```

```{r, echo = FALSE}
NN_ts <- readRDS('./Flanders_Natura2000/NN_ts.rds')
plot(NN_ts)
```
:::
...
```{r, echo = FALSE}
OD_map <- readRDS('./Flanders_Natura2000/OD_map.rds')
plot(OD_map)
```

```{r, echo = FALSE, eval=FALSE}
OD_ts <- readRDS('./Flanders_Natura2000/OD_ts.rds')
plot(OD_ts)
```
:::
...
```{r, echo = FALSE, eval= FALSE}
OT_ts <- readRDS('./Flanders_Natura2000/OT_ts.rds')
plot(OT_ts)
```
:::
