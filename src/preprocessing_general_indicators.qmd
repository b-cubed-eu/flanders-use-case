...
Define the sql-query to download the data from GBIF.
See this [link](https://techdocs.gbif.org/en/data-use/api-sql-download-functions) on how to create an sql-query and relevant functions.
```{r}
