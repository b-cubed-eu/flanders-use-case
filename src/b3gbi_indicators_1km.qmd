...
```{r, echo = FALSE}
OSR_map <- readRDS("./Flanders_1km/OSR_map.rds")
plot_map(OSR_map,
         ,visible_gridlines = FALSE)
```
...
```{r, echo = FALSE}
TO_map <- readRDS('./Flanders_1km/TO_map.rds')
...
```{r, echo = FALSE}
PEM_map <- readRDS('./Flanders_1km/PEM_map.rds')
...
```{r, echo = FALSE}
WEM_map <- readRDS('./Flanders_1km/WEM_map.rds')
plot_map(WEM_map,
         visible_gridlines = FALSE)
```
...
```{r, echo = FALSE}
AbRM_map <- readRDS('./Flanders_1km/AbRM_map.rds')
...
```{r, echo = FALSE}
ArRM_map <- readRDS('./Flanders_1km/ArRM_map.rds')
plot_map(ArRM_map, visible_gridlines = FALSE)
```
...
```{r, echo = FALSE}
SR_map <- readRDS('./Flanders_1km/SR_map.rds')
plot_map(SR_map,
        visible_gridlines = FALSE)
```
...
```{r, echo = FALSE}
HSh_map <- readRDS('./Flanders_1km/HSh_map.rds')
plot_map(HSh_map,
         visible_gridlines = FALSE)
```
...
```{r, echo = FALSE}
HSi_map <- readRDS('./Flanders_1km/HSi_map.rds')
plot_map(HSi_map,
         visible_gridlines = FALSE)
```
...
```{r, echo = FALSE}
NN_map <- readRDS('./Flanders_1km/NN_map.rds')
plot_map(NN_map,
         visible_gridlines = FALSE)
```
...
```{r, echo = FALSE}
OD_map <- readRDS('./Flanders_1km/OD_map.rds')
plot_map(OD_map, 
         visible_gridlines = FALSE)
```
