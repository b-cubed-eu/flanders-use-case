...
### Limitations
Observed species richness depends a lot on how the data was collected. If some areas are studied more carefully or more often than others, they will usually appear to have more species—just because people looked more thoroughly.
It also depends on the species themselves. Rare species, or those that are spread out, are harder to find and may be missed during surveys. In addition, some species are easier to detect than others, which can also affect the results.
